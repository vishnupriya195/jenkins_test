...
pipeline {
    ...
    stages {
        ...
        stage("Approval") {
            ...
            steps {
                emailext body: "Please click at $BUILD_URL/input to approve the deployment \n This link is valid for 1 minute \n Git commit id is ${GIT_COMMIT} commited by ${GIT_COMMITTER_NAME}", to: "sathishbob@gmail.com", subject: '$PROJECT_NAME is ready for deployment - Build number is $BUILD_NUMBER - Please approve to proceed with deployment'
